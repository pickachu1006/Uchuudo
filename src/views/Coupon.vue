            ...
            <div class="form-group">
              ...
              <div class="form-group ">
                ...
                <input type="number" class="form-control" id="percent"
                  placeholder="請輸入分類" v-model="tempCoupon.percent">
              </div>
              <div class="form-group ">
                <label for="code">優惠碼</label>
                <input type="text" class="form-control" id="code"
                  placeholder="請輸入單位" v-model="tempCoupon.code">
              </div>
            
              <div class="form-group">
              <label for="due_date">期限</label>
                <input type="date" class="form-control" id="due_date"
                  placeholder="請輸入原價" v-model="tempCoupon.due_date">
              </div>
            ...
            <div class="form-group">
              <div class="form-check">
                <input class="form-check-input" type="checkbox"
                  id="is_enabled" v-model="tempCoupon.is_enabled" :true-valu="1" :false-value="0">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content border-0">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger" @click="deletOK"
          >確認刪除</button>
      </div>
    </div>
  </div>
      ...
      openModal(isNew,item){ 
          ...
          if(isNew){
            ...
            //不是新的話，就將該商品傳入tempCoupon，但為避免傳參考，使用ES6物件方法
              ...
              let MM = ((new Date(vm.tempCoupon.due_date).getMonth() + 1)<10 ? '0':'')+(new Date(vm.tempCoupon.due_date).getMonth() + 1);
              let DD = (new Date(vm.tempCoupon.due_date).getDate()<10 ? '0':'')+(new Date(vm.tempCoupon.due_date).getDate());
